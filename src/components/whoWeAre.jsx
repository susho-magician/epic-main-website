...
export default function WhoWeAre() {
  ...
  return (
    <div
      id="who-we-are"
      className="flex flex-col md:flex-row justify-between gap-4 py-[40px] bg-[#161B21] bg-[url('/assets/whoBackground.png')] bg-cover bg-center px-[16px] md:px-[80px]"
    >
      <img
        src="/assets/who.png"
      ...
      >
        <div className="flex items-center justify-center md:juustify-start mb-[16px] gap-3">
          ...
          <img src="/assets/icons/star.png" className="w-[24px]" alt="Epic" />
        </div>
