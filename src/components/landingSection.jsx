...
import LandingPageUnderline from "../assets/landingUnderline.png";
...
export default function LandingSection() {
  ...
  return (
    <div className="w-full lg:py-[125px] py-[75px] bg-center  bg-[url('/assets/homePageBg1.png')] bg-cover px-[16px] md:px-[0px]">
      <p
