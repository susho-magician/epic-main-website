      ...
      >
        ...
        >
          <p
            style={{
              background:
                "linear-gradient(0deg, #374151, #374151), radial-gradient(142.39% 1113.97% at 32.52% 41.25%, #5E7BFE 0%, #2342CE 100%)",
              backgroundClip: "text",
            }}
          ...
          <div className="text-[#11151AB2] text-[16px] mt-3">{description2}</div>
        </div>
      </div>
    </motion.div>
  );
...
const CardsContainer = ({ cards }) => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      cards.forEach((card, index) => {
        controls.start({
          scale: 1 - data.ToReduceBy[index] * 0.1,
        });
      });
    };
...
const StackingCards = () => {
  const cardsData = [
    ...
    },
    {
      ...
      description2: "Real-time insights, competitor monitoring, growth forecasting.",
      index: 3,
    },
    {
      title: "Brand Protection & Compliance",
      description2: "MAP enforcement, counterfeit detection, unauthorized sellers.",
      index: 4,
    },
    {
    ...
    },
    {
      ...
      description2: "Amazon attribution, referral bonuses, influencer collaborations",
      index: 6,
    },
    {
