...
import DataGlobe from "./globe.json";
import Navbar from "./components/navbar";
import { managementTabs } from "./data/managementSolutions";
    ...
    <div className="h-screen w-full">
      ...
      <div className="bg-[#F7F9FC] py-[16px]">
        <div className="flex h-[50px] items-center justify-end gap-3 p-[6px] rounded-[12px] ps-[20px] w-max mx-auto bg-[linear-gradient(91.34deg,#2342CC_0.01%,#0A259D_100.01%),radial-gradient(142.39%_1113.97%_at_32.52%_41.25%,#5E7BFE_0%,#2342CE_100%)]">
          <div className="text-[#F9F7FC] text-[16px] font-[600]">
      ...
      <div className="bg-[url('/cardBackground.png')] bg-no-repeat bg-[#F7F9FC] flex flex-col md:flex-row justify-between px-[16px] md:px-[80px] pt-[30px] md:pt-[70px]">
        <div className="mx-[16px] md:mx-0">
          <div className="text-[#374151] font-[500] text-[20px] md:text-[40px] mb-[16px] max-w-[500px] text-center md:text-start">
            End-to-End eCommerce Management Services
          </div>
      ...
      <div className="flex flex-col items-center bg-[#161B21] bg-[url('/assets/epicGlobalBackground.png')] bg-cover bg-center py-[40px] px-[16px] md:px-[80px]">
        ...
        <div className="max-w-[600px] mx-auto text-[#F7F9FCB2] text-[14px] md:text-[16px] text-center mb-[24px]">
          Empowering brands with infinite growth potential through global
          eCommerce expansion, AI-driven insights, and strategic marketplace
          management.
        </div>
        ...
        <div>
          <div className="md:flex hidden gap-4">
            ...
            >
              <h2 className="md:text-[32px] text-[20px] font-[500] mb-2">
                No Fees,
                <br />
                No Risk
              </h2>
              <p className="text-[#F7F9FC]">
                We buy your product upfront and handle everything.
              </p>
            </div>
            <div
              style={{
            ...
            >
              <div className="p-6">
                ...
                <p className="text-[#F7F9FC]">
                  Selling in 47+ countries across 30+ platforms.
                </p>
              </div>
              <div className="flex items-end">
                <Player
                  ...
                  loop
                  autoplay
                  style={{ width: 180, borderRadius: "0px 0px 24px 0px" }}
                />
              </div>
            </div>
            <div
              ...
              className="backdrop-blur-[31.4px] bg-[#EBEBE129] rounded-[24px] p-6 text-white w-1/4"
            >
              <h2 className="text-[32px] font-[500] mb-2">
                AI-Driven
                <br />
                Insights
              </h2>
              <p className="text-[#F7F9FC]">
                Proprietary tools to optimize and scale.
              </p>
            </div>
          </div>
          <div className="flex md:hidden gap-4">
            ...
            >
              ...
              <p className="text-[#F7F9FCCC] text-[12px] md:text-[14px]">
                We buy your product upfront and handle everything.
              </p>
            </div>
            <div
            ...
            >
              ...
              <div className="flex items-end">
                <Player
                  ...
                  loop
                  autoplay
                  style={{ width: 120, borderRadius: "0px 0px 24px 0px" }}
                />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-4">
            ...
            >
              <div>
                ...
                <p className="text-[#F7F9FCCC] text-[12px] md:text-[14px]">
                  We do it all: listings, ads, fulfillment, brand protection.
                </p>
              </div>
      ...
      <div className="bg-[#F7F9FC] flex flex-col items-center py-[40px] px-[16px] md:px-[80px] bg-[url('/assets/solutionsBackground.png')] bg-cover bg-center">
        <div className="text-[#374151] font-[500] text-[20px] text-center md:text-start md:text-[40px] mb-[32px]">
          End-to-End eCommerce Management Solutions
        </div>
        <div className="w-full mx-auto">
          <div className="flex justify-start md:justify-center mb-4 overflow-scroll md:overflow-hidden">
            {managementTabs.map((tab) => (
              <button
                ...
                className={`px-4 py-[2px] mx-2 rounded-[100px] cursor-pointer min-w-max md:w-[180px] h-[38px] ${
                  activeTab === tab.id
                    ? "bg-[linear-gradient(0deg,#2342CE,#2342CE),radial-gradient(142.39%_1113.97%_at_32.52%_41.25%,#5E7BFE_0%,#2342CE_100%)] text-[#F7F9FC]"
                    : "text-[#2342CE]"
                }`}
          ...
          <div className="pt-[28px] max-w-[1120px] mx-auto bg-white rounded-[24px] backdrop-blur-[31.4px]">
            <div className="mb-3 px-[28px]">
              <img
                src={`${
                  managementTabs.find((tab) => tab.id === activeTab).image
                }`}
                alt="epic"
                className={`${activeTab < 4 ? "h-[40px]" : "h-[65px]"}`}
              />
            </div>
            <div className="text-[#374151] text-[20px] mb-[28px] px-[28px]">
              {managementTabs.find((tab) => tab.id === activeTab).content}
            </div>
            <div className="p-[28px] bg-[radial-gradient(circle,#5E7BFE_0%,#2342CE_100%)] rounded-[24px]">
              {activeTab < 4 && (
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {managementTabs
                    .find((tab) => tab.id === activeTab)
                    .stats.map((eachStat, index) => {
                      return (
                        <div key={index}>
                          <div className="text-[#C6FE95] text-[28px] font-[700]">
                            {eachStat.number}
                          </div>
                          <div className="text-[#F7F9FC] text-[16px]">
                            {eachStat.description}
                          </div>
                        </div>
                      );
                    })}
              ...
              {activeTab === 4 && (
                <ul className="list-disc grid grid-cols-2 md:grid-cols-3 gap-[20px]">
                  {managementTabs
                    .find((tab) => tab.id === activeTab)
                    .stats.map((eachStat, index) => {
                      return (
                        <li className="text-[#F7F9FC] text-[16px]" key={index}>
                          {eachStat}
                        </li>
                      );
                    })}
      ...
      <div className="text-center bg-[radial-gradient(142.39%_1113.97%_at_32.52%_41.25%,_#5E7BFE_0%,_#2342CE_100%)]">
        <div className="bg-[url('/brandSuccessBackground.png')] py-[40px] px-[16px] md:px-[80px] bg-cover bg-end bg-no-repeat">
          <div className="text-[#F7F9FC] text-[20px] md:text-[40px] mb-[48px]">
